...
import { isActionPhase, getPlayerBench } from '@/schemas/gameSchemas'
...
export default function ActionBar({
    ...
    const getDefendButtonState = () => {
        ...
        return { enabled: true, tooltip: selectedDefendersCount > 0 ? `Commit ${selectedDefendersCount} defenders` : "Assign defenders to lanes" }
    }
        ...
        <div className={`flex flex-col gap-3 ${className}`}>
            ...
            <div className="flex flex-col gap-2">
              ...
              `}
                ...
                {!['action', 'declare_defenders', 'combat', 'end_round', 'mulligan'].includes(gameState?.phase || '') && (
