  ...
  return (
    <div className="absolute inset-0 opacity-5 pointer-events-none overflow-hidden">
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ zIndex: -1 }} aria-hidden="true">
        <title>Decorative constellation pattern</title>
        <defs>
      ...
      <div className="absolute top-1/5 left-1/5">
        <div className="w-1 h-1 bg-gray-400 rounded-full animate-ping delay-3000" />
      </div>
      <div className="absolute bottom-1/5 right-1/5">
        <div className="w-1 h-1 bg-gray-500 rounded-full animate-ping delay-4000" />
      </div>
      <div className="absolute top-2/5 left-4/5">
        <div className="w-1 h-1 bg-gray-400 rounded-full animate-ping delay-5000" />
      </div>
    </div>
  )
}
