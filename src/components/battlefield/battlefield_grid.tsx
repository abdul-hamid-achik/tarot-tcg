  ...
  return (
    ...
    >
      <div className="grid grid-cols-[120px_1fr] gap-4 items-stretch">
        ...
        <div className="grid grid-cols-6 gap-3">{renderGridRow(0)}</div>

        {/* Enemy Attack Row */}
        <div className="text-sm text-gray-700 flex items-center justify-end pr-3 font-semibold">
          {getRowLabel(1)}
        </div>
        <div className="grid grid-cols-6 gap-3">{renderGridRow(1)}</div>
        ...
        <div className="grid grid-cols-6 gap-3">{renderGridRow(2)}</div>

        {/* Player Bench Row */}
        <div className="text-sm text-gray-700 flex items-center justify-end pr-3 font-semibold">
          {getRowLabel(3)}
        </div>
        <div className="grid grid-cols-6 gap-3">{renderGridRow(3)}</div>
      </div>
    </div>
  )
}
