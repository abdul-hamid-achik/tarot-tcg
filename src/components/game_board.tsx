...
export default function GameBoard({
  ...
  const { ui, interaction, hideCardDetail, setGameState } = useGameStore()

  const { playCard, declareAttack, declareDefenders, endTurn, completeMulligan, reverseCard } =
    useGameActions()
  ...
  return (
    <GameLayout>
      ...
      <HandFan
        ...
        onCardDetail={() => {
          // TODO: Implement card detail display
        }}
      />
      ...
      <MulliganOverlay
        ...
        onClose={() => {
          // TODO: Implement mulligan overlay close
        }}
