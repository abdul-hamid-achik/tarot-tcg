          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Badge className={`${card.rarity === 'legendary' ? 'bg-black text-white' :
                  card.rarity === 'rare' ? 'bg-gray-800 text-white' :
                    card.rarity === 'uncommon' ? 'bg-gray-700 text-white' : 'bg-gray-600 text-white'
                  }`}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {card.keywords.map((keyword) => (
                      <Badge key={keyword} variant="secondary" className="text-xs bg-gray-200 text-gray-800">
                        {keyword}
                      </Badge>
                    ))}
                  </div>
              ...
              <div className="space-y-2">
                ...
                <div className={`text-sm leading-relaxed ${card.isReversed ? 'text-gray-700' : 'text-gray-600'}`}>
          ...
          <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-300">
            ...
            {onReverse && (
              <Button
                ...
                disabled={!canReverse}
                className={`transition-all duration-200 ${card.isReversed
                    ? 'bg-gray-700 hover:bg-gray-800 text-white'
                    : 'bg-gray-800 hover:bg-black text-white'
                  } disabled:opacity-50`}
                title={card.isReversed ? 'Return card to upright position' : 'Reverse this card (tarot mechanic)'}
              >
