...
export function EmoteWheel({ onEmote, className }: EmoteWheelProps) {
    ...
    const [selectedCategory, setSelectedCategory] = useState<'all' | 'major' | 'minor' | 'elements'>('all')

    const filteredEmotes = TAROT_EMOTES.filter(emote => {
        switch (selectedCategory) {
            case 'major': return emote.arcana === 'major'
            case 'minor': return emote.arcana === 'minor'
            case 'elements': return emote.element !== undefined
            default: return true
        }
    })
                                ...
                                {filteredEmotes.map(emote => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            emote.mood === 'positive' && 'bg-green-600/20 hover:bg-green-600/30 border border-green-600/30',
                                            emote.mood === 'negative' && 'bg-red-600/20 hover:bg-red-600/30 border border-red-600/30',
                                            emote.mood === 'neutral' && 'bg-purple-600/20 hover:bg-purple-600/30 border border-purple-600/30',
                                        )}
                                        title={emote.text}
                                    >
