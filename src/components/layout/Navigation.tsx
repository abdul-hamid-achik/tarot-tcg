...
export function Navigation({ className = '' }: NavigationProps) {
  ...
  return (
    <header className={`bg-background border-b border-border shadow-sm transition-colors ${className}`}>
              ...
              return (
                <Link key={item.href} href={item.href}>
                  <Button
                    ...
                    size="sm"
                    className={`flex items-center space-x-2 transition-colors ${active
