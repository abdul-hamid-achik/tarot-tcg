    ...
    try {
        ...
        try {
            ...
            const response = {
                ...
                timestamp: Date.now(),
                serverOrientation: action.type === 'play_card' ? findLastPlacedUnit(newState, playerId)?.isReversed : undefined
            }
...
function validateEndTurn(gameState: GameState, playerId: PlayerId, action: any): ActionValidation {
...
// Action application
async function applyAction(gameState: GameState, action: any, playerId: PlayerId): Promise<GameState> {
...
async function applyPlayCard(gameState: GameState, action: any, playerId: PlayerId): Promise<GameState> {
...
async function applyAttack(gameState: GameState, action: any, playerId: PlayerId): Promise<GameState> {
...
async function applyEndTurn(gameState: GameState, playerId: PlayerId): Promise<GameState> {
